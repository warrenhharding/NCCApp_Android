...
public class DetailUserUploadedDocument extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "DetailUserDocument";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_user_uploaded_document);
        ...
        DetailUserUploadedDocument.progressBar.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.largeMenuButton) {
            ...
            Intent docIntent = new Intent(this, RetrieveMyUserDocuments.class);
    ...
    public void getDocForDisplay() {
        ...
        String fullUrlString = "/userUploadedDocuments/" + mAuth.getCurrentUser().getUid()+ "/" + recordId;
        Uri fullUrl = Uri.parse(fullUrlString);

        // storageRef.child("/files/"+recordId).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
        // storageRef.child("/userUploadedDocuments/"+mAuth.getCurrentUser().getUid()).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
        storageRef.child(fullUrlString).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
    ...
    public void displayInPDFViewer() {
        ...
        new DetailUserUploadedDocument.RetrievePFDStream().execute(downloadUrl.toString());
    }
    ...
    public void sendFileByEmail() {
        ...
        if(fileWithinMyDir.exists()) {
            ...
            Toast.makeText(DetailUserUploadedDocument.this, "Lookslike the file isn't there...", Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean isWriteStoragePermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                new DownloadTask(DetailUserUploadedDocument.this, downloadFiles, downloadUrl.toString(), recordId);
                return true;
            } else {
