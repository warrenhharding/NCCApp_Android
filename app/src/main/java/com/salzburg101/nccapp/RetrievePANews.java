...
public class RetrievePANews extends AppCompatActivity implements View.OnClickListener  {


    ProcessBadges instance = new ProcessBadges(this);

    ArrayList<StructureForRetrieveAllPANews> paNewsSummary = new ArrayList<StructureForRetrieveAllPANews>();
...
//    public static final String readAlerts = "readAlerts" ;
    ...
    private static ListenerNewPANewsReceived mListener;

    public static void setListenerNewPANews(ListenerNewPANewsReceived eventListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.retrieve_all_panews);
        ...
        paNewsSummary = DefinePANewsSummary.getInstance().getArrayList();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                StructureForRetrieveAllPANews selectedOrder = paNewsSummary.get(position);
...
//                startActivity(detailIntent);
        ...
        mListView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                AdapterPANewsSummary adapter = new AdapterPANewsSummary(getApplicationContext(), paNewsSummary);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_alerts:
                        ...
                        // Toast.makeText(RetrievePANews.this, "Alerts", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_news:
                        ...
                        finish();
                        // overridePendingTransition(0, 0);
                        // Toast.makeText(RetrievePANews.this, "News", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_events:
                        ...
                        finish();
                        // overridePendingTransition(0, 0);
                        // Toast.makeText(RetrievePANews.this, "Events", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_documents:
                        ...
                        finish();
                        // overridePendingTransition(0, 0);
                        // Toast.makeText(RetrievePANews.this, "Documents", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_pa:
//                        finish();
...
//                        overridePendingTransition(0, 0);
//                        Toast.makeText(RetrievePANews.this, "PA News", Toast.LENGTH_SHORT).show();
                        break;
                }
                return true;
            }
        ...
        bottomNavigationView.setSelectedItemId(R.id.action_pa);
...
//        }
    ...
    public void retrievePreviousOrderSummary() {
        ...
        Query query = mNoticesDatabaseReference.child("ParAssNews");
...
//                    adapter.notifyDataSetChanged();
                    ...
                    System.out.println("The alertSummary arrayList shoud now be empty: " + paNewsSummary);
                    for (DataSnapshot alerts : dataSnapshot.getChildren()) {
                        ...
                        if (alerts.child("headline").exists()) {
                            message = alerts.child("headline").getValue().toString();
                        ...
                        paNewsSummary.add(new StructureForRetrieveAllPANews(message, userName, date, recordId, timeInterval));
                        System.out.println("The alertSummary arrayList should now have a new entry: " + paNewsSummary);
...
//                        }
    ...
    private void sortArrayList() {
        ...
        Collections.sort(paNewsSummary, new Comparator<StructureForRetrieveAllPANews>() {
            DateFormat f = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss");
            @Override
            public int compare(StructureForRetrieveAllPANews t1, StructureForRetrieveAllPANews structureForRetrieveAllPANews) {
                try {
                    return f.parse(structureForRetrieveAllPANews.getDate()).compareTo(f.parse(t1.getDate()));
                } catch (ParseException e) {
    ...
    private void getBadgeNumber() {
        ...
        System.out.println("alertSummary has " + paNewsSummary.size() + " entries.");
        final Integer n = paNewsSummary.size();

        System.out.println("readAlerts should total " + alertsArray.size() + " entries.");
        Integer unreadCount = 0;
        for (int i = 0; i < n; i++) {
            StructureForRetrieveAllPANews paNews = paNewsSummary.get(i);
            String recordId;
            recordId = paNews.getRecordId();
            if (!alertsArray.contains(recordId)) {
                unreadCount = unreadCount + 1;
            }

            if (unreadCount > 0) {
                navBar.showBadge(R.id.action_pa).setNumber(unreadCount);
