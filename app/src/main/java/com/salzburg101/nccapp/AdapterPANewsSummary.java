...
public class AdapterPANewsSummary extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private ArrayList<StructureForRetrieveAllPANews> mDataSource;
...
//    }
    ...
    public AdapterPANewsSummary(Context context, ArrayList<StructureForRetrieveAllPANews> items) {
        mContext = context;
        mDataSource = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = mInflater.inflate(R.layout.list_item_panews, parent, false);
        ...
        // 1
        StructureForRetrieveAllPANews alert = (StructureForRetrieveAllPANews) getItem(position);
        String recordId;
